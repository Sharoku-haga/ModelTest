...
#define USERVERTE2D_FVF (D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1)				//!< 頂点フォーマットのマクロ(法線ベクトルを含む)
...
public:
	...
	* @param[in] isFullScreen	フルスクリーンかどうか  trueならフルスクリーン falseなら通常
...
private:
	...
	bool					m_isFullScreen;	//!< フルスクリーンかどうか  trueならフルスクリーン falseなら通常
};
